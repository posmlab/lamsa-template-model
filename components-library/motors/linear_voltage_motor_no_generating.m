%% linear_motor struct
% NOTE: this is a weird motor, in which 
%       there is a linear Force vs Velocity tradeoff, 
%       except that when the velocity of the motor exceeds its 
%       maximum velocity, it 
...
function motor = linear_voltage_motor_no_generating(F_motor_max_max, v_motor_max_max, range_of_motion, voltage_fraction)
