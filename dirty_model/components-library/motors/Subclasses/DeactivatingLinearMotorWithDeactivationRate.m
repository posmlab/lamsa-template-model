%% DeactivatingLinearMotorWithDeactivationRate object
...
classdef DeactivatingLinearMotorWithDeactivationRate < Motor
    ...
    methods
        function obj = DeactivatingLinearMotorWithDeactivationRate(F_motor_max, v_motor_max, range_of_motion,r_deactivation, varargin)
            % optional parameters
            ...
            if (length(varargin)>length(varargin_param_names))
                error('Too many input parameters. Linear motor requires at least 4 paramters.');
            end
