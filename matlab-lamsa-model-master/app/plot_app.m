...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        function one_D_plot(app)
            ...
            for i=1:N    
                ...
                % spring struct initialization
                spring = initialize_spring(app.spring.SelectedTab);
                if (app.spring.SelectedTab == app.linear_spring)
                    spring = LinearSpring(app.linear_spring_k.Value,app.linear_spring_mass.Value,app.linear_spring_Fmax.Value);
                elseif (app.spring.SelectedTab == app.exponential_spring)
                    spring = ExponentialSpring(app.exp_spring_k.Value,app.exp_spring_char_len.Value,app.exp_spring_mass.Value,app.exp_spring_Fmax.Value);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        function sensitivity(app)
            ...
            if (app.spring.SelectedTab == app.linear_spring)
                spring_str = "spring_fun = @(x0)LinearSpring(app.linear_spring_k.Value,app.linear_spring_mass.Value,app.linear_spring_Fmax.Value);";
            elseif (app.spring.SelectedTab == app.exponential_spring)
                spring_str = "spring_fun = @(x0)ExponentialSpring(app.exp_spring_k.Value,app.exp_spring_char_len.Value,app.exp_spring_mass.Value,app.exp_spring_Fmax.Value);";
            elseif (app.spring.SelectedTab == app.linear_elastic_extensional_spring)
                spring_str = "spring_fun = @(x0)LinearElasticExtensionalSpring(app.lee_spring_E.Value,app.lee_spring_A.Value,app.lee_spring_L.Value,app.lee_spring_rho.Value,app.lee_spring_sigma_f.Value);";
            end
