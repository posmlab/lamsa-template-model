...
loading_motor = HillMuscleMotor(.006, 18, 5, 200, .006, 2.08, -2.89, -0.75);
...
latch = ParabolicLatch(150, 1e-3, 1e-3, 0, 1e2, 0, Inf, 0);
% "k" "m_s" "F_spring_max" "rest length"
spring = LinearSpring(200, 0.01, Inf, 0.005);
...
[sol2,t_times2]=solve_lamsa_se(tspan,loading_motor,unlatching_motor,load,latch,spring);
